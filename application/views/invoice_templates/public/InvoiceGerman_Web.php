    ...
    <div id="content">
        ...
        <div class="webpreview-header">
                ...
                <a href="<?php echo site_url('guest/view/generate_invoice_pdf/' . $invoice_url_key); ?>"
                   class="btn btn-primary">
                    ...
                    <a href="<?php echo site_url('guest/view/generate_sumex_pdf/' . $invoice_url_key); ?>"
                       class="btn btn-primary">
                        <?php endif; ?>
                        <i class="fa fa-print"></i> <?php echo trans('download_invoice_pdf'); ?>
                    </a>
			...
			if (count($attachments) > 0) { ?>
				<div>
					<h4><?php echo trans('attachments_invoice'); ?></h4>
								...
								<tr class="attachments">
									...
									<td>
										<a href="<?php echo site_url('guest/get/attachment/' . $attachment['fullname']); ?>"
										   class="btn btn-primary btn-topsm">
        ...
        <div class="invoice">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6 col-lg-5 text-right">
                    <h4><?php _htmlsc($invoice->user_company); ?><br></h4>
                    <p>
                        ...
                        <?php if ($invoice->user_phone) {
							echo trans('phone_abbr') . ':';
							echo htmlsc($invoice->user_phone). '<br>';
                        } ?>
                        <?php if ($invoice->user_fax) {
							echo trans('fax_abbr'). ':';
							echo htmlsc($invoice->user_fax). '<br>';
						} ?>
						<?php if ($invoice->user_mobile) {
							echo trans('mobile') . ': ' . htmlsc($invoice->user_mobile) . '<br>';
						} ?>
                    </p>
                    <br>
